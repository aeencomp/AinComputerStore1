...
import { Save, Store, Palette, Search, Home, CreditCard, FileText, Plus, Trash2, GripVertical, ExternalLink, Link as LinkIcon, RotateCcw, XCircle, Loader2, ArrowRight } from "lucide-react";
