  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        {!searchQuery && !selectedCategory && (
          <section className="py-12 md:py-16 bg-gradient-to-b from-primary/5 to-transparent" data-testid="section-order-tracking">
            <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
              <div className="bg-card rounded-lg border shadow-sm p-6 md:p-10">
                <div className="flex flex-col md:flex-row items-center gap-6 md:gap-10">
                  <div className="flex-shrink-0">
                    <div className="w-20 h-20 md:w-24 md:h-24 rounded-full bg-accent/20 flex items-center justify-center">
                      <Package className="w-10 h-10 md:w-12 md:h-12 text-accent-foreground" />
                    </div>
                  </div>
                  <div className="flex-1 text-center md:text-start">
                    <h2 className="text-2xl md:text-3xl font-bold mb-2" data-testid="text-order-tracking-title">
                      {t('home.orderTracking.title')}
                    </h2>
                    <p className="text-lg text-primary font-medium mb-2" data-testid="text-order-tracking-subtitle">
                      {t('home.orderTracking.subtitle')}
                    </p>
                    <p className="text-muted-foreground" data-testid="text-order-tracking-description">
                      {t('home.orderTracking.description')}
                    </p>
                  </div>
                  <div className="flex flex-col sm:flex-row gap-3">
                    <Button asChild size="lg" className="gap-2" data-testid="link-track-order">
                      <Link href="/track-order">
                        <Package className="w-4 h-4" />
                        {t('home.orderTracking.trackBtn')}
                      </Link>
                    </Button>
                  </div>
                </div>
