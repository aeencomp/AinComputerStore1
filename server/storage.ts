...
export interface IStorage {
  ...
  createRepairTicket(ticket: CreateRepairTicketInput): Promise<RepairTicket>;
...
export class MemStorage implements IStorage {
  ...
  async updateStoreSettings(settings: Partial<InsertStoreSettings>): Promise<StoreSettings> {
    const defaultSettings: StoreSettings = {
      ...
      phone: "920001234",
      phoneAr: "٩٢٠٠٠١٢٣٤",
      addressAr: "كربلاء، العراق",
      addressEn: "Karbala, Iraq",
  ...
  async createRepairTicket(ticket: CreateRepairTicketInput): Promise<RepairTicket> {
